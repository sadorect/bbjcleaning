...
<h1 style="color:#199e59;direction:ltr;font-family:'Roboto Slab', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:74px;font-weight:700;letter-spacing:normal;line-height:120%;text-align:left;margin-top:0;margin-bottom:0;">Brightbell Janitors Cleaning Services<br/> </h1>
</div>
<div class="bee-block bee-block-3 bee-paragraph">
<p>World-class cleaning for your properties and personal space.</p>
</div>
...
<div class="bee-block bee-block-1 bee-paragraph">
<p><strong>Hello Sir </strong><br/><strong>Someone tried to reach out from the web. Pleae find the contact details below. </strong></p>

 <h4> Name : {{ $message['name'] }}</h4>
 <h4> Phone : {{ $message['phone'] }}</h4>
 <h4> Email: <a href="mailto:{{ $message['email'] }}?subject='{{ $message["email"] }}'">{{ $message['email'] }}</a></h4>
...
<p>You can click on the email address for a direct reply and the subject line is auto-included.<br/>Cheers!</p>
</div>
<div class="bee-block bee-block-2 bee-button"><a class="bee-button-content" href="http://www.example.com" style="font-size: 14px; background-color: #3c3c3c; border-bottom: 0px solid transparent; border-left: 0px solid transparent; border-radius: 20px; border-right: 0px solid transparent; border-top: 0px solid transparent; color: #ffffff; direction: ltr; font-family: inherit; font-weight: 400; letter-spacing: 1px; max-width: 100%; padding-bottom: 5px; padding-left: 40px; padding-right: 40px; padding-top: 5px; width: auto; display: inline-block;" target="_self"><span dir="ltr" style="word-break: break-word; font-size: 14px; line-height: 200%; letter-spacing: 1px;"></span></a></div>
</div>
